...
@tag
Feature: To validate makemytrip application

  @tag1
  Scenario: To validate search result and payment page is visible or not 
    Given Open browser 
    And Enter url
    When Click on hotels
    And Click on location
    And Enter location fetch location
    And Fetch dates 
    ...
    And Booking dates should be visible
